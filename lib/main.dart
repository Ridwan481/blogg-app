  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          '/rootapp': (BuildContext context) => Myapp(),
          '/loding': (BuildContext context) => Loding(),
          '/login': (BuildContext context) => Login(),
          '/regester': (BuildContext context) => Regester(),
          '/states': (BuildContext context) => States(),
          '/getsate': (BuildContext context) => Getsate(),
